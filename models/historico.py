...
class Historico:
    ...
    def transacoes(self) -> List[Dict[str, Any]]:
        ...
        Returns:
            List[Dict[str, Any]]: Lista de transações.
        """
        return self._transacoes

    def adicionar_transacao(self, transacao: Any, conta: Any) -> None:
        """
        ...
        Args:
            transacao (Any): Objeto de transação a ser adicionado (deve ter um atributo 'valor').
            conta (Any): Objeto de conta associado à transação.
        ...
        numero_conta: str = conta.numero  # Obtém o número da conta associada à transação
